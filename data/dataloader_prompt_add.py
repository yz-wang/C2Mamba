...
class lowlight_loader(data.Dataset):
	...
	def __getitem__(self, index):
		...
		if ("normal" in data_lowlight_path)or("output"in data_lowlight_path)or("/data/HQ/"in data_lowlight_path)or("gt"in data_lowlight_path)or("high"in data_lowlight_path)or("GT"in data_lowlight_path):
